...
const deleteWorkout = async (req, res, next) => {
    ...
    try {
        ...
        //Borramos likes con el id del workout que eliminamos
        await connection.query(`DELETE FROM likes WHERE id_workout = ?`, [
            idWorkout,
        ]);

        //Borramos favorites con el id del workout que eliminamos
        await connection.query(`DELETE FROM favorite WHERE id_workout = ?`, [
            idWorkout,
        ]);
